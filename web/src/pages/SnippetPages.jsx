// Merged snippet pages

import React, { useEffect, useState } from 'react'
import { Badge, Box, Button, Flex, HStack, Input, Select, SimpleGrid, Spinner, Text, Textarea, useToast } from '@chakra-ui/react'
      ...
      <Flex justify="space-between" align="start" mb="16px">
        <Box flex={1}>
          <HStack gap="10px" mb="6px" flexWrap="wrap">
            ...
            {lang && (
              <HStack gap="5px">
                <Box w="10px" h="10px" rounded="full" bg={LANG_COLORS_SnippetPages[lang] || '#888'} />
...
export { Snippets, SnippetDetail, NewSnippet, EditSnippet }
