...
type FolioSchema struct {
	...
	Task             *goent.Table[models.Task]
	TaskAttachment   *goent.Table[models.TaskAttachment]
	TaskSchedule     *goent.Table[models.TaskSchedule]
	TaskIssue        *goent.Table[models.TaskIssue]
