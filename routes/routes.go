...
func setupRepoCRUDRoutes(repo fiber.Router) {
	...
	repo.Post("/retry-migrate", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.RetryMigrate)
}
...
func setupRepoGitRoutes(repo fiber.Router) {
	...
	repo.Put("/default-branch", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.SetDefaultBranch)
	repo.Post("/tags", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.CreateTag)
	repo.Delete("/tags/:name", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.DeleteTag)
	repo.Post("/branches", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.CreateBranch)
	repo.Delete("/branches/:name", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.DeleteBranch)
	repo.Post("/branches/rename", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.RenameBranch)
	repo.Post("/merge", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.MergeBranch)
	repo.Post("/cherry-pick", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.CherryPick)
	repo.Post("/delete-commits", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.DeleteCommitRange)
	repo.Post("/revert", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.RevertCommit)
	repo.Post("/reset", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.ResetCommits)
	repo.Post("/abort", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.AbortOperation)
	repo.Get("/git-status", middleware.OptionalAuth(), handlers.GetRepoStatus)
	...
	repo.Post("/edit-file", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.EditFile)
	repo.Delete("/file", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.DeleteFile)
	repo.Get("/remotes", middleware.OptionalAuth(), handlers.ListRemotes)
	repo.Post("/remotes", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.AddRemote)
	repo.Delete("/remotes/:name", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.RemoveRemote)
	repo.Put("/remotes/:name/url", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.SetRemoteURL)
	repo.Post("/remotes/:name/push-url", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.AddRemotePushURL)
	repo.Delete("/remotes/:name/push-url", middleware.AuthMiddleware(), middleware.GuestReadOnly(), handlers.RemoveRemotePushURL)
